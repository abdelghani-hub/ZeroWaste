...
export const collectRequestReducer = createReducer(
    ...
    on(CollectRequestActions.loadCollectorRequests, state => ({
        ...state,
        loading: true
    })),

    on(CollectRequestActions.loadCollectorRequestsSuccess, (state, {requests}) => ({
        ...state,
        requests,
        loading: false,
        error: null
    ...
    on(CollectRequestActions.loadCollectorRequestsFailure, (state, {error}) => ({
        ...state,
        loading: false,
        error
    })),
    ...
    on(CollectRequestActions.assignCollectorSuccess, (state, {request}) => ({
        ...state,
        requests: state.requests.map(req =>
            req.id === request.id ? request : req
        )
